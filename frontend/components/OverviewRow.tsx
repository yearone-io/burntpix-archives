...
export const OverviewRow = ({ collectionStats, burntPicId }: IOverviewRowProps) => {
    return (
        <Grid
        ...
        >
            ...
            <GridItem colSpan={1} px={{base: 0, md: 7}} py={7} borderRight={{base: "0px", lg: "1px solid #000000"}}>
                <BurntPixArt burntPicId={burntPicId} />
            </GridItem>
            <GridItem as={Flex} justifyContent={"center"} alignItems={"center"} colSpan={{ base: 1, md: 2, lg: 1 }} px={{base: 0, md: 7}} py={7} borderTop={{base: "1px solid #000000", lg: "0px"}}>
                <EditorsNote />
            </GridItem>
        </Grid>
    );
